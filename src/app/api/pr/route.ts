...
Generated autonomously by **equity** (Codex + GPT-5.6). Each item below was detected by static/WCAG analysis and fixed with a minimal, behavior-preserving change.
...
---
_Generated by equity · Codex + GPT-5.6 · OpenAI Build Week 2026_`;
